...
This project is meant to be an airdrop contract where users can claim a BagelToken. It also applies the concepts of Signature and therefore other approved users can pay the gas fees and claim for the user.
...
```bash
git clone https://github.com/dharminnagar/airdrop-contract.git
cd airdrop-contract
...
If you appreciated this, please follow [Dharmin Nagar!](https://x.com/DharminNagar)